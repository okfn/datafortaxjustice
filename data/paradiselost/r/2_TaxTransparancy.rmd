...
```{r}
for(i in 1: nrow(taxtransparancy)) {
if (taxtransparancy$ratings[i] %in% c("Non Compliant", "NA") & taxtransparancy$schedulerating[i] != "before 30 june 2018") {taxtransparancy$criteria.1[i] <- "no"
...
write.xlsx(taxtransparancy, file = "final blacklist/final blacklist.xlsx", sheetName = "Tax transparancy", row.names = FALSE, col.names = TRUE, append = FALSE, showNA = FALSE)
```
