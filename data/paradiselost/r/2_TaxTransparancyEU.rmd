...
```{r}
for(i in 1: nrow(taxtransparancy)) {
if (taxtransparancy$ratings[i] %in% c("Non Compliant")) {taxtransparancy$criteria.1[i] <- "no"}
...
write.xlsx(taxtransparancy, file = "final blacklist/final blacklist-EU.xlsx", sheetName = "Tax transparency", row.names = FALSE, col.names = TRUE, append = FALSE, showNA = FALSE)
```
