...
for (i in 1:nrow(list)) { if (list$Passes.Criterion.Tax.Transparency[i] == "no"|list$Passes.Criterion.Anti.Beps[i] == "no")
...
png(file = "plots/blacklistgdppop.png", width = 800, height = 600)
...
png(file = "plots/fairbepsgdppop.png", width = 800, height = 600)
...
png(file = "plots/blacklistgdpcap.png", width = 800, height = 600)
...
png(file = "plots/fairbepsgdpcap.png", width = 800, height = 600)
...
png(file = "plots/barblacklist.png", width = 800, height = 600)
...
png(file = "plots/barfairbeps.png", width = 800, height = 600)
ggplot(data = list) + geom_histogram(aes(x= log(GDP.in..Billions), 
